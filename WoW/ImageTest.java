...
public class ImageTest extends JFrame{
    ...
    class MyPanel extends JPanel{
        public void paintComponent(Graphics g){
            ...
            pX = getWidth(); pY = getHeight();
            g.drawImage(image, 0, 0, pX/2, pY/2, 0, 0, X/2, Y/2, this);
            g.drawImage(image, pX/2+10, 0, pX+10, pY/2, X/2, 0, X, Y/2, this);
            g.drawImage(image, 0, pY/2+10, pX/2, pY+10, 0, Y/2, X/2, Y, this);
            g.drawImage(image, pX/2+10, pY/2+10, pX+10, pY+10, X/2, Y/2, X, Y, this); // 사진 그리기
        }
    }
